...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-special-gamma/tags). For example,

```javascript
iterGamma = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-gamma@v0.2.1-umd/browser.js' )
```
